...
export default {
  ...
  about: {
    bio: [
      ...
      "Today I work full-stack on the web building enterprise platforms: systems with real-time collaboration, AI-assisted document processing, and multi-app architectures with centralized SSO. React + TypeScript + Tailwind on the front, .NET / C# and Node.js (NestJS) on the back, with end-to-end ownership of production infrastructure (VPS, Docker, Nginx). For cross-platform mobile I reach for React Native. If you have an idea, I'll find the right tools to make it happen.",
