...
export default {
  ...
  projects: {
    ...
    titles: {
      ...
      "ash-and-ale": "Ash & Ale — Multiplayer AI RPG",
    ...
    descriptions: {
      ...
      "ash-and-ale": "Real-time multiplayer RPG over raw WebSockets, with AI-controlled party members that have their own personality, persistent memory, and banter/strategize together mid-combat. The turn-based combat engine runs rules through an embedded Lua VM (fengari), and higher-tier class evolutions are generated by the AI based on each character's personality and history. Automatic fallback across 11 LLM providers keeps the game running without a narrator gap. Backend in Node.js + WebSocket, client in React + Zustand.",
    ...
    results: {
      ...
      "ash-and-ale": [
        "AI companions with personality, persistent memory and combat banter",
        "AI-generated class evolutions based on personality and history",
        "Automatic fallback across 11 LLM providers + embedded Lua rules engine"
      ],
      "pignus-liderando": [
