...
export default {
  ...
  about: {
    bio: [
      ...
      "Hoy trabajo full-stack en web construyendo plataformas empresariales: sistemas con colaboración en tiempo real, documentos analizados con IA y arquitecturas multi-app con SSO centralizado. React + TypeScript + Tailwind en el front, .NET/C# y Node.js (NestJS) en el back, con responsabilidad end-to-end de la infraestructura de producción (VPS, Docker, Nginx). Tengo ownership completo de los proyectos: trabajo directo con los clientes desde el levantamiento de requerimientos hasta la puesta en producción y el soporte. Para móvil multiplataforma uso React Native. Si tienes una idea, encuentro las herramientas adecuadas para hacerla realidad.",
